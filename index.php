                                                                     ...
                                                                     <div ng-transclude="fields">
                                                                        <card-fields class="ng-scope">
                                                                           <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="cpf" icon="user-outline" error-message="'Número de CPF inválido'">
                                                                              <input cpf="" type="tel" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" id="arroxa" autofocus="$ctrl.$modal.isEmpty()" maxlength="14" ng-minlength="14" ng-required="true" ng-model="$ctrl.cpf" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" onkeypress="formatar_mascara(this,'###.###.###-##')" name="cpf" >
